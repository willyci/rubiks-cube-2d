// Pure JS 3D vector math to compute level moves for 3x3 and 2x2 (Option A)
class Vec3 {
...
for (const f of FACES) {
  ...
  const arrowDefs = [
    { key: 'top_left',     dir: 'left',  D: axes.r.negate(), sliceNorm: axes.u.clone() },
    { key: 'top_right',    dir: 'right', D: axes.r.clone(),  sliceNorm: axes.u.clone() },
    { key: 'bottom_left',  dir: 'left',  D: axes.r.negate(), sliceNorm: axes.u.negate() },
    { key: 'bottom_right', dir: 'right', D: axes.r.clone(),  sliceNorm: axes.u.negate() },
    { key: 'left_up',      dir: 'up',    D: axes.u.clone(),  sliceNorm: axes.r.negate() },
    { key: 'left_down',    dir: 'down',  D: axes.u.negate(), sliceNorm: axes.r.negate() },
    { key: 'right_up',     dir: 'up',    D: axes.u.clone(),  sliceNorm: axes.r.clone() },
    { key: 'right_down',   dir: 'down',  D: axes.u.negate(), sliceNorm: axes.r.clone() }
  ];
...
console.log('const FACE_LEVEL_MOVES = ' + JSON.stringify(result, null, 2) + ';');
