    ...
    const SCRAMBLE_LENGTH = 40;  // WCA random-move length for this size
    ...
    const RING_CONFIG = {
      ...
      delta: 0.098,  // spacing between concentric rings
      beadSize: 0.074,
      frustum: 2.38,
    };
    ...
    const METHODS = [
      { id: "reduction", label: "Reduction", stages: [
        { title: "1. 六面中心 (Centers)", badge: "Step 1", desc: "拼好六个面的 2×2 中心块，注意各色中心的相对位置。" },
        { title: "2. 棱块配对 (Edge Pairing)", badge: "Step 2", desc: "把 12 组同色棱块两两配对，组成完整棱条。" },
        { title: "3. 三阶化还原 (3x3 Stage)", badge: "Step 3", desc: "中心与棱条完成后，按三阶魔方方法还原。" },
        { title: "4. 奇偶校验 (Parity)", badge: "Step 4", desc: "处理四阶特有的 OLL / PLL 奇偶情况，完成六面还原！" },
      ] },
      { id: "yau", label: "Yau", stages: [
        { title: "1. 首两中心 (First 2 Centers)", badge: "Step 1", desc: "先拼好白、黄两个相对中心。" },
        { title: "2. 三棱十字 (3 Cross Edges)", badge: "Step 2", desc: "配对并放好白色十字的三条棱。" },
        { title: "3. 余下四中心 (Last 4 Centers)", badge: "Step 3", desc: "保持十字不动，拼好剩余四个中心。" },
        { title: "4. 棱块配对 (Edge Pairing)", badge: "Step 4", desc: "补齐第四条十字棱，并配对其余棱块。" },
      ...
      { id: "hoya", label: "Hoya", stages: [
        ...
        { title: "2. 十字棱 (Cross Edges)", badge: "Step 2", desc: "配对并放好白色十字的四条棱。" },
        { title: "3. 末两中心 (Last 2 Centers)", badge: "Step 3", desc: "拼好最后两个中心。" },
        { title: "4. 余下棱块 (Remaining Edges)", badge: "Step 4", desc: "配对剩余的八条棱。" },
        { title: "5. 三阶收尾 (3x3 Stage)", badge: "Step 5", desc: "按三阶方法完成还原并处理奇偶。" },
      ] },
      { id: "k4", label: "K4", stages: [
        { title: "1. 首两中心 (First 2 Centers)", badge: "Step 1", desc: "拼好左右两个中心。" },
        { title: "2. 左侧块 (Left 1×3×4 Block)", badge: "Step 2", desc: "在左侧搭建 1×3×4 块。" },
        { title: "3. 右侧块 (Right 1×3×4 Block)", badge: "Step 3", desc: "在右侧搭建 1×3×4 块。" },
        { title: "4. 末层角块 (CLL)", badge: "Step 4", desc: "一次还原末层的四个角块。" },
        { title: "5. 末层棱与中心 (ELL + Centers)", badge: "Step 5", desc: "用三循环还原剩余棱块与中心。" },
      ] },
    ];
    ...
    const SCRAMBLE_PROFILES = [
      { name: "打乱 #1 · WCA 标准打乱 (WCA Standard)", scramble: "Rw' Uw Lw' Uw2 R D R Dw' L2 F Dw2 Lw Dw R2 Bw Lw2 Uw2 Bw2 R' Bw2 D' R2 B Lw2 Bw' Lw2 Bw2 U B2 L2 Uw R' B Dw' R D L Dw F Rw" },
      { name: "打乱 #2 · 宽层密集 (Wide-Heavy)", scramble: "U' Lw Uw2 B2 R2 Dw2 Bw2 Lw Uw' Bw2 R Dw2 Rw Fw D' Rw2 Bw2 Dw Bw Lw B Uw2 Bw' L Fw2 Lw' D Bw Dw2 Rw' Uw2 B' Rw2 Bw2 U' B2 R' Dw' L Fw" },
      { name: "打乱 #3 · 外层主导 (Outer-Heavy)", scramble: "R' F' U' Bw R D' L' Fw2 R U2 F2 U F' L U B' L2 B2 L U L B' R2 D F U2 R2 D Rw F R D' Lw2 F Lw' D B2 D' F' Uw'" },
      { name: "打乱 #4 · 长序列挑战 (Marathon)", scramble: "Bw' Uw2 L' Uw' Bw2 Lw U L2 F2 Dw2 L' D B Dw' Bw' D2 F Dw2 B R2 Fw' U B' L D2 B2 Uw2 Lw' Bw2 U B2 Lw Dw2 Rw2 B' Uw2 Bw2 Dw B2 L Fw' Rw U2 Rw2 Uw2 R2 B2 Dw2 Bw2 D' Rw' Uw' Lw' D Rw' Bw2 R U' Rw' D2" },
    ];
